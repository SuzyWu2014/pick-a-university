...
class Score2015Spider(scrapy.spiders.Spider):
    name = 'score_2015'
    allowed_domains = ['gkcx.eol.cn']
    params = {'page': 150, 'recomschtype': '普通本科', 'recomluqupici': '一批', 'scoreSign': 3, 'schoolSort': 4, 'recomyear': 2015, 'argprovince': '福建', 'argluqutype': '理科'}
