...
class Score2014Spider(scrapy.spiders.Spider):
    name = 'score_2014'
    allowed_domains = ['gkcx.eol.cn']
    params = {'page': 430, 'recomschtype': '普通本科', 'recomluqupici': '一批', 'scoreSign': 3, 'schoolSort': 4, 'recomyear': 2014, 'argprovince': '福建', 'argluqutype': '理科'}
