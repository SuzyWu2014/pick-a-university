...
class University2012Spider(scrapy.spiders.Spider):
    name = 'university_2012'
    allowed_domains = ['gkcx.eol.cn']
    params = {'page': 1, 'recomschtype': '普通本科', 'recomluqupici': '一批', 'scoreSign': 3, 'schoolSort': 7, 'recomyear': 2012, 'argprovince': '福建', 'argluqutype': '理科'}
